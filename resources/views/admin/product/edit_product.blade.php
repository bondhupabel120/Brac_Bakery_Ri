            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-info">
                        ...
                        <form method="POST" action="{{ route('product.update',['product'=>$product->id]) }}" enctype="multipart/form-data" role="form">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            ...
                                            <input type="text" name="name" class="custom-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $product->name }}" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            <label>Product Price <span class="text-danger">*</span></label>
                                            <input type="number" name="price" step="0.001" class="custom-control {{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ $product->price }}" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            <label>Product Sale Price <span class="text-danger">*</span></label>
                                            <input type="text" name="sale_price" step="0.001" class="custom-control {{ $errors->has('sale_price') ? ' is-invalid' : '' }}" value="{{ $product->sale_price }}" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            <label>Quantity <span class="text-danger">*</span></label>
                                            <input type="text" name="quantity" step="0.001" class="custom-control {{ $errors->has('quantity') ? ' is-invalid' : '' }}" value="{{ $product->quantity }}" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            ...
                                            <div>
                                                <img class="img-thumbnail" id="details_image_preview" src="{{ $product->image ? asset($product->image) : asset('assets/admin/img/no_image_found.png') }}" style="height: 70px; width: 120px;" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            ...
                                            <div>
                                                <img class="img-thumbnail" id="details_image1_preview" src="{{ $product->image1 ? asset($product->image1) : asset('assets/admin/img/no_image_found.png') }}" style="height: 70px; width: 120px;" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
                                            ...
                                            <div>
                                                <img class="img-thumbnail" id="details_image2_preview" src="{{ $product->image2 ? asset($product->image2) : asset('assets/admin/img/no_image_found.png') }}" style="height: 70px; width: 120px;" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="custom-group">
                                            ...
                                            <textarea name="description" id="editor" cols="59" rows="5" class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" autofocus>{{ $product->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-group">
